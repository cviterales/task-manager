...
const Orders = () => {
  ...
  useEffect(() => {
    getOrders(id_service, valuesSelected.typeSelected, valuesSelected.stateSelected)
      .then(setOrders)
  ...
  const renderOrders = (orders) => {
    return orders.map((order, index) => {
      return (
        <li className={styles.item} key={order.id_order}>
    ...
    <>
      ...
      <div className={styles.filters}>
        <div className={styles.input_container}>
          ...
          <Selector nameKey="typeSelected" data={types} onSelected={filterHandler} />
        </div>
        <div className={styles.input_container}>
          <p className={styles.boldText}>Estado</p>
          <Selector nameKey="stateSelected" data={status} onSelected={filterHandler} />
        </div>
      </div>
